...
import myImage from "../img/myImage_1.png";
				...
				<div className="row" style={{ marginTop: 7 + "rem" }}>
					<div className="col-12 col-lg-6 hidden">
						...
						<p className={"mytext pt-3 " + this.props.fadeIn}>
							I welcome the opportunuty to take your creative ideas and turn
							them into reality using my coding expertise. My commitment and 
							passion are reflected in my work.
						</p>
					</div>
					<div
						className={
